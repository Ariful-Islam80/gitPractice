...
const LogIn = () => {
    ...
    const handleLogIn = ev => {
        ...
        signInUser(email, password)
            .then(result => {
                setRegisterSuccess('Your Email is successfully logIn')
    ...
    const handleGoogleBtn = () => {
        signInWithGoogle()
            .then(res => {
                navigate(currentLocation)
                registerSuccess('Your LogIn is Success!')
            })
            .catch(error => {
                console.error(error);
            })
        ...
        <>
            <div className=" flex items-center justify-center mt-12">
                <div className="max-w-md w-full p-6">
                    <h1 className="text-3xl font-semibold mb-6 text-green-500 text-center">Log<span className="text-orange-500">In</span></h1>
                    <div className="mt-4 flex flex-col lg:flex-row items-center justify-between">
                        <div className="w-full lg:w-1/2 mb-2 lg:mb-0">
                            <button onClick={handleGoogleBtn} type="button" className="w-full flex justify-center items-center gap-2 bg-white text-sm text-gray-600 p-2 rounded-md hover:bg-gray-50 border border-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-200 transition-colors duration-300">
                        ...
                        <div className="w-full lg:w-1/2 ml-0 lg:ml-2">
                            <button onClick={handleGitHubBtn}  type="button" className="w-full flex justify-center items-center gap-2 bg-white text-sm text-gray-600 p-2 rounded-md hover:bg-gray-50 border border-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-200 transition-colors duration-300">
                    ...
                    <div className="mt-4 text-sm text-gray-600 text-center">
                        ...
                        <p className="text-lg">Are you New to this Website?<Link to="/register" className="text-black hover:underline"><span className="text-green-500 font-bold"> Register Now</span></Link>
                        </p>
                    </div>
                </div>
            </div>
